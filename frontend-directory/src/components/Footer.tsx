      ...
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="flex flex-col space-y-2">
            <h5 className=" text-lg pb-5">Pink Pony Facts</h5>
          ...
          <div className="flex flex-col space-y-2">
            <h5 className=" text-lg pb-5">Terms & Conditions</h5>
            <a href="#" className="hover:text-gray-400">
              Terms
            </a>
            <a href="#" className="hover:text-gray-400">
          ...
          <div className="flex flex-col space-y-2">
            <h5 className=" text-lg pb-5">Fair Use</h5>
            <a href="#" className="hover:text-gray-400">
          ...
          <div className="flex flex-col space-y-2">
            <h5 className=" text-lg pb-5">Missouri S&T</h5>
            <a href="#" className="hover:text-gray-400">
              Go Miners
            </a>
            <a href="#" className="hover:text-gray-400">
